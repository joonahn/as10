        ...
        with open(fname, 'rt') as f: 
            ...
            for line in f:
                ...
                if l == "":
                    ...
                    m = re_label.search(l)
                    if m is not None:
                        self.label[m.group(1)] = 0 # Always NULL
                    # data ?
                    # Ignore data; fun program does not need a data
                    continue
                else:
                    # text mode
                    # label ?
